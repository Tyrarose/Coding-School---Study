...
class Checking(Balance):
    ...
    def withdrawMoney():
      ...
      # Pay Bills Using Checking Account
    def payBill():
        Checking.printCurrentBalance()
      ...
      # Main Menu of the Checking Account
    def menu():
        b = True
        while b:
            print("""
...
class Savings(Balance):
    ...
    def depositMoney():
      ...
      # Make Investment Using Savings Account
    def makeInvestment():
        Savings.printCurrentBalance()
